...
import { Image } from '../../projects/ngx-photoswipe/src/public-api';
...
export class AppComponent implements OnInit {
    ...
    addPhoto() {
        const imageNb = Math.round(Math.random() * 100);
        this.images.push({
            img: `https://mdbootstrap.com/img/Photos/Horizontal/Nature/12-col/img%20(${imageNb}).jpg`,
            thumb: `https://mdbootstrap.com/img/Photos/Horizontal/Nature/12-col/img%20(${imageNb}).jpg`,
        });
    }
}
